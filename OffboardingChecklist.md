...
## Assignee
- [ ] [Remove them](https://get.slack.help/hc/en-us/articles/212906697-User-Groups) from `@cg-team`, `@cg-operator`s, and any other `@cg-` teams in the Slack Team Directory

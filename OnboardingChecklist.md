...
- [ ] `#cg-business` - business development
- [ ] `#cg-compliance` - compliance-related information and discussion
- [ ] `#cg-offtopic` - off-topic team sharing 
- [ ] `#devops-public` - public-facing channel for devops that sometimes discusses cloud.gov
- [ ] `#cg-platform` - platform operations
- [ ] `#cg-platform-news` - platform operations-related bot notifications
- [ ] `#cg-program` - program-level information and discusion
- [ ] `#cg-support` - support requests and assistance within TTS
- [ ] `#cg-fec-shared` - a shared channel with FEC for business and support comms

...
- [ ] `#cloud-gov` - announcements in a read-only channel
...
* [ ] Read the [Internal developer and operations documentation](https://github.com/cloud-gov/internal-docs/)
* [ ] Review the [Dependency Diagram](https://github.com/cloud-gov/internal-docs/blob/main/about/dependency-diagram.png)
...
* [ ] Take a look at [our existing brokers](https://github.com/cloud-gov?q=broker&type=&language=).
* [ ] Check out our [staging](https://ci.fr-stage.cloud.gov/) and [production](https://ci.fr.cloud.gov) Concourse instances, and take a look at some of [our pipelines](https://github.com/search?q=org%3Acloud-gov+cg-deploy).
...
- [ ] Install the Concourse `fly` CLI
  ...
  - [ ] Verify using `fly -h`
- [ ] Install cloud.gov dev tools by cloning the [`cg-scripts` repo](https://github.com/18F/cg-scripts/)

...
* Grant them access to the following:
  ...
  * [ ] PagerDuty
  * [ ] StatusPage
* [ ] Make sure that PagerDuty will alert you:
  ...
  * [ ] Make sure that PagerDuty is set up to alert you via email as well, and make sure that when it sends you an alert, it gets into your inbox, not spam.  If it gets into spam, releasing the spam seems to make it so that future emails will not make it there.
